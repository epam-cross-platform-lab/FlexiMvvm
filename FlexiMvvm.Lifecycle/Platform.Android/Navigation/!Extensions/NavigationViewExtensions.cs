...
namespace FlexiMvvm.Navigation
{
    ...
    public static class NavigationViewExtensions
    {
        ...
        /// <returns>The <see cref="FragmentActivity"/> instance.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="view"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentException">
        /// <para><paramref name="view" /> is derived from a class other than the <see cref="FragmentActivity"/> or <see cref="Fragment"/>.</para>
        /// <para>-or-</para>
        /// <para>The activity reference is <c>null</c> for the provided <paramref name="view"/>.</para>
        /// </exception>
        public static FragmentActivity GetActivity(this INavigationView<IViewModel> view)
        {
            ...
            if (fragmentActivity == null)
            {
                throw new ArgumentException(
                    $"The activity reference is 'null' for the provided '{TypeFormatter.FormatName(view.GetType())}' view.", nameof(view));
            }
