...
{
    [Register("fleximvvm.views.v4.FlxDialogFragment")]
    public class FlxDialogFragment : DialogFragment, IFlxFragment
    {
        [CanBeNull]
        private IViewDelegate<FlxDialogFragment> _viewDelegate;
        ...
        [NotNull]
        protected IViewDelegate<FlxDialogFragment> ViewDelegate => _viewDelegate ?? (_viewDelegate = CreateViewDelegate());

        [NotNull]
        protected virtual IViewDelegate<FlxDialogFragment> CreateViewDelegate()
        {
            return new ViewDelegate<FlxDialogFragment>(this);
        }
    ...
    public class FlxDialogFragment<TViewModel> : FlxDialogFragment, IFlxFragment<TViewModel>
        where TViewModel : class, IViewModelWithoutParameters, IViewModelWithState
    {
        [NotNull]
        private new IViewDelegate<FlxDialogFragment<TViewModel>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxDialogFragment<TViewModel>, TViewModel>)base.ViewDelegate;
        ...
        {
            return new ViewDelegate<FlxDialogFragment<TViewModel>, TViewModel>(this);
        }
    ...
    public class FlxDialogFragment<TViewModel, TParameters> : FlxDialogFragment, IFlxFragment<TViewModel>
        where TViewModel : class, IViewModelWithParameters<TParameters>, IViewModelWithState
        where TParameters : ViewModelParametersBase
    {
        [NotNull]
        private new IViewDelegate<FlxDialogFragment<TViewModel, TParameters>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxDialogFragment<TViewModel, TParameters>, TViewModel>)base.ViewDelegate;
        ...
        protected override IViewDelegate<FlxDialogFragment> CreateViewDelegate()
        {
            return new ViewDelegate<FlxDialogFragment<TViewModel, TParameters>, TViewModel>(this);
        }
