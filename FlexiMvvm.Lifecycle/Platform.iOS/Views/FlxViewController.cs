...
{
    public class FlxViewController : UIViewController, IFlxViewController
    {
        [CanBeNull]
        private IViewDelegate<FlxViewController> _viewDelegate;
        ...
        [NotNull]
        protected IViewDelegate<FlxViewController> ViewDelegate => _viewDelegate ?? (_viewDelegate = CreateViewDelegate());
        ...
        [NotNull]
        protected virtual IViewDelegate<FlxViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxViewController>(this);
        }
    ...
    public class FlxViewController<TViewModel> : FlxViewController, IFlxViewController<TViewModel>
        where TViewModel : class, IViewModelWithoutParameters
    {
        public event EventHandler<ViewModelResultSetEventArgs> ResultSet;

        [NotNull]
        private new IViewDelegate<FlxViewController<TViewModel>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxViewController<TViewModel>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxViewController<TViewModel>, TViewModel>(this);
        }
    ...
    public class FlxViewController<TViewModel, TParameters> : FlxViewController, IFlxViewController<TViewModel>
        ...
        where TParameters : ViewModelParametersBase
    {
        ...
        public FlxViewController([CanBeNull] TParameters parameters)
        {
        ...
        [NotNull]
        private new IViewDelegate<FlxViewController<TViewModel, TParameters>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxViewController<TViewModel, TParameters>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxViewController<TViewModel, TParameters>, TViewModel>(this);
        }
