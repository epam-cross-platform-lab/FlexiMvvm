...
{
    public class FlxNavigationController : UINavigationController, IFlxViewController
    {
        [CanBeNull]
        private IViewDelegate<FlxNavigationController> _viewDelegate;
        ...
        [NotNull]
        protected IViewDelegate<FlxNavigationController> ViewDelegate => _viewDelegate ?? (_viewDelegate = CreateViewDelegate());
        ...
        [NotNull]
        protected virtual IViewDelegate<FlxNavigationController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxNavigationController>(this);
        }
    ...
    public class FlxNavigationController<TViewModel> : FlxNavigationController, IFlxViewController<TViewModel>
        where TViewModel : class, IViewModelWithoutParameters
    {
        public event EventHandler<ViewModelResultSetEventArgs> ResultSet;

        [NotNull]
        private new IViewDelegate<FlxNavigationController<TViewModel>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxNavigationController<TViewModel>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxNavigationController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxNavigationController<TViewModel>, TViewModel>(this);
        }
    ...
    public class FlxNavigationController<TViewModel, TParameters> : FlxNavigationController, IFlxViewController<TViewModel>
        ...
        where TParameters : ViewModelParametersBase
    {
        ...
        public FlxNavigationController([CanBeNull] TParameters parameters)
        {
        ...
        [NotNull]
        private new IViewDelegate<FlxNavigationController<TViewModel, TParameters>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxNavigationController<TViewModel, TParameters>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxNavigationController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxNavigationController<TViewModel, TParameters>, TViewModel>(this);
        }
