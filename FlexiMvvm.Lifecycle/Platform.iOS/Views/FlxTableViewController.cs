...
{
    public class FlxTableViewController : UITableViewController, IFlxViewController
    {
        [CanBeNull]
        private IViewDelegate<FlxTableViewController> _viewDelegate;
        ...
        [NotNull]
        protected IViewDelegate<FlxTableViewController> ViewDelegate => _viewDelegate ?? (_viewDelegate = CreateViewDelegate());
        ...
        [NotNull]
        protected virtual IViewDelegate<FlxTableViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxTableViewController>(this);
        }
    ...
    public class FlxTableViewController<TViewModel> : FlxTableViewController, IFlxViewController<TViewModel>
        where TViewModel : class, IViewModelWithoutParameters
    {
        public event EventHandler<ViewModelResultSetEventArgs> ResultSet;

        [NotNull]
        private new IViewDelegate<FlxTableViewController<TViewModel>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxTableViewController<TViewModel>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxTableViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxTableViewController<TViewModel>, TViewModel>(this);
        }
    ...
    public class FlxTableViewController<TViewModel, TParameters> : FlxTableViewController, IFlxViewController<TViewModel>
        ...
        where TParameters : ViewModelParametersBase
    {
        ...
        public FlxTableViewController([CanBeNull] TParameters parameters)
        {
        ...
        [NotNull]
        private new IViewDelegate<FlxTableViewController<TViewModel, TParameters>, TViewModel> ViewDelegate =>
            (IViewDelegate<FlxTableViewController<TViewModel, TParameters>, TViewModel>)base.ViewDelegate;

        public TViewModel ViewModel => ViewDelegate.ViewModel;

        protected override IViewDelegate<FlxTableViewController> CreateViewDelegate()
        {
            return new ViewDelegate<FlxTableViewController<TViewModel, TParameters>, TViewModel>(this);
        }
