...
{
    public class UITableViewBindableItemCell<TItemsContext, TItem> : UITableViewObservableItemCell<TItemsContext, TItem>
        ...
        where TItem : class
    {
        ...
        public UITableViewBindableItemCell()
        {
        }

        public UITableViewBindableItemCell(NSCoder coder)
            : base(coder)
        {
        }

        public UITableViewBindableItemCell(CGRect frame)
            : base(frame)
        {
        }

        public UITableViewBindableItemCell(UITableViewCellStyle style, string reuseIdentifier)
            : base(style, reuseIdentifier)
        {
        }

        public UITableViewBindableItemCell(UITableViewCellStyle style, NSString reuseIdentifier)
            : base(style, reuseIdentifier)
        {
        }

        protected UITableViewBindableItemCell(NSObjectFlag t)
            : base(t)
        {
        }

        protected internal UITableViewBindableItemCell(IntPtr handle)
            : base(handle)
        {
        }
