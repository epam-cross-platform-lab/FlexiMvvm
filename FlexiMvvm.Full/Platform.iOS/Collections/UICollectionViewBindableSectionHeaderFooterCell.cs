...
{
    public class UICollectionViewBindableSectionHeaderFooterCell<TItemsContext>
        ...
        where TItemsContext : class
    {
        ...
        public UICollectionViewBindableSectionHeaderFooterCell()
        {
        }

        public UICollectionViewBindableSectionHeaderFooterCell(NSCoder coder)
            : base(coder)
        {
        }

        public UICollectionViewBindableSectionHeaderFooterCell(CGRect frame)
            : base(frame)
        {
        }

        protected UICollectionViewBindableSectionHeaderFooterCell(NSObjectFlag t)
            : base(t)
        {
        }

        protected internal UICollectionViewBindableSectionHeaderFooterCell(IntPtr handle)
            : base(handle)
        {
        }
    ...
    public class UICollectionViewBindableSectionHeaderFooterCell<TItemsContext, TGroup>
        : UICollectionViewObservableSectionHeaderFooterCell<TItemsContext, TGroup>
        where TItemsContext : class
        where TGroup : class
    {
        [CanBeNull]
