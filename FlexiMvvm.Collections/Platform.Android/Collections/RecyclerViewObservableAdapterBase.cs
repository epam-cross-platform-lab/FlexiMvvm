...
{
    public abstract class RecyclerViewObservableAdapterBase : RecyclerView.Adapter
    {
        ...
        private protected RecyclerViewObservableAdapterBase([NotNull] RecyclerView recyclerView)
        {
        ...
        [NotNull]
        private protected abstract ItemsMappingBase GetItemsMapping();
