...
{
    public class RecyclerViewObservableHeaderFooterViewHolder<TItemsContext> : RecyclerViewObservableViewHolder
    {
        public RecyclerViewObservableHeaderFooterViewHolder([NotNull] View itemView)
            : base(itemView)
        {
        }
