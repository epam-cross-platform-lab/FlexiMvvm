...
{
    public abstract class RecyclerViewObservablePlainAdapterBase : RecyclerViewObservableAdapterBase
    {
        ...
        protected RecyclerViewObservablePlainAdapterBase([NotNull] RecyclerView recyclerView)
            : base(recyclerView)
        {
        }
        ...
        public override int GetItemViewType(int position)
        {
            ...
            switch (itemMap.Type)
            {
                case ItemType.SectionHeader:
                    return ViewType.GetTarget(ItemType.SectionHeader, DefaultViewType);
                case ItemType.SectionFooter:
                    return ViewType.GetTarget(ItemType.SectionFooter, DefaultViewType);
                default:
