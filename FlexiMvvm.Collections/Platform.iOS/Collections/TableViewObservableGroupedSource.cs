...
{
    public class TableViewObservableGroupedSource : TableViewObservableSource
    {
        [CanBeNull]
        ...
        public TableViewObservableGroupedSource(
        ...
        {
            TableViewObservableSectionHeaderFooterCell sectionHeaderCell = null;
        ...
        {
            TableViewObservableSectionHeaderFooterCell sectionFooterCell = null;
