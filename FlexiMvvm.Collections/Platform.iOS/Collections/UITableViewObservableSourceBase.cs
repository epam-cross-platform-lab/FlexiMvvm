...
{
    public abstract class UITableViewObservableSourceBase : UITableViewSource
    {
        ...
        private protected UITableViewObservableSourceBase(
        ...
        public override UITableViewCell GetCell([NotNull] UITableView tableView, [NotNull] NSIndexPath indexPath)
        {
            ...
            var itemCell = (UITableViewObservableItemCell)tableView.DequeueReusableCell(itemCellReuseId, indexPath).NotNull();
