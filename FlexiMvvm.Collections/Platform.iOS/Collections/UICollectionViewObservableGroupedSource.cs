...
{
    public class UICollectionViewObservableGroupedSource : UICollectionViewObservableSourceBase
    {
        [CanBeNull]
        ...
        public UICollectionViewObservableGroupedSource(
            ...
            [NotNull] NSIndexPath indexPath)
        {
            ...
            var sectionHeaderFooterCell = (UICollectionViewObservableSectionHeaderFooterCell)collectionView.DequeueReusableSupplementaryView(
                elementKind,
