...
{
    public class UICollectionViewDelegateFlowLayout : UIKit.UICollectionViewDelegateFlowLayout
    {
        public UICollectionViewDelegateFlowLayout()
        {
        }

        protected UICollectionViewDelegateFlowLayout(NSObjectFlag t)
            : base(t)
        {
        }

        protected internal UICollectionViewDelegateFlowLayout(IntPtr handle)
            : base(handle)
        {
        }
