...
{
    public class WeakAction : WeakDelegateBase, IWeakAction
    {
    ...
    public class WeakAction<T> : WeakDelegateBase, IWeakAction<T>
    {
    ...
    public class WeakAction<T1, T2> : WeakDelegateBase, IWeakAction<T1, T2>
    {
    ...
    public class WeakAction<T1, T2, T3> : WeakDelegateBase, IWeakAction<T1, T2, T3>
    {
    ...
    public class WeakAction<T1, T2, T3, T4> : WeakDelegateBase, IWeakAction<T1, T2, T3, T4>
    {
    ...
    public class WeakAction<T1, T2, T3, T4, T5> : WeakDelegateBase, IWeakAction<T1, T2, T3, T4, T5>
    {
