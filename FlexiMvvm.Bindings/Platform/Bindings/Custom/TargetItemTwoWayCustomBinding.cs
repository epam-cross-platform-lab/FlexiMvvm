...
{
    public class TargetItemTwoWayCustomBinding<TItem, TValue, TEventArgs> : TargetItemBinding<TItem, TValue>, ITargetItemCommandListener<TItem>
        where TItem : class
    {
        [NotNull]
        ...
        [NotNull]
        private readonly Action<TItem, TValue> _setValue;

        public TargetItemTwoWayCustomBinding(
            ...
            [NotNull] Action<TItem, TValue> setValue,
    ...
    public class TargetItemTwoWayCustomBinding<TItem, TValue> : TargetItemTwoWayCustomBinding<TItem, TValue, EventArgs>
        where TItem : class
    {
        public TargetItemTwoWayCustomBinding(
            [NotNull] IItemReference<TItem> itemReference,
